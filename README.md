...
1. Push service images (identity, ngo, service-catalog, ai) to your container registry.
2. Update Supabase values in `k8s/platform.yaml` (`rdi-config` and `rdi-secrets`).
3. Set registry prefix and deploy:
   - `export RDI_IMAGE_PREFIX=ghcr.io/<your-org>/refugee`
   - `./scripts/deploy.sh k8s`


### Vercel deployment (via GitHub)

- Frontend-only deploy guide: `docs/vercel-deployment.md`
